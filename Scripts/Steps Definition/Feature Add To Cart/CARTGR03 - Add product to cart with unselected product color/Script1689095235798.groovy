...
WebUI.callTestCase(findTestCase('Pages/Add To Cart/Select Color'), [('color') : 'unselected'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Add To Cart/Click Add To Cart'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Add To Cart/Read Notice Options Not Selected'), [('expected') : ''], FailureHandling.STOP_ON_FAILURE)
