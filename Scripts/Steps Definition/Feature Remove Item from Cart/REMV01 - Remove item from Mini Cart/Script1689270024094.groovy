...
WebUI.callTestCase(findTestCase('Pages/Shopping Cart/Click Remove Button'), [('btn_remove') : 'minicart'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Shopping Cart/Mini Cart/Verify Modals Remove Item'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Shopping Cart/Mini Cart/Click OK to Remove Item'), [:], FailureHandling.STOP_ON_FAILURE)
