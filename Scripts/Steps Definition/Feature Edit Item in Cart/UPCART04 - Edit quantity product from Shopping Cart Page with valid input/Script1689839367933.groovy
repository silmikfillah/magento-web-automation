...
WebUI.callTestCase(findTestCase('Pages/Shopping Cart/Edit Quantity'), [('qty') : 'shopping_cart'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Shopping Cart/Click Update Shopping Cart Button'), [('btn_update') : 'shopping_cart'], 
