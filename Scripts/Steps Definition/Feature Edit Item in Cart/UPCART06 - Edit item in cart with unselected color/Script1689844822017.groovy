...
WebUI.callTestCase(findTestCase('Pages/Shopping Cart/Click Edit Button'), [('btn_edit') : 'shopping_cart'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Shopping Cart/Edit Size'), [('size') : 'selected'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Shopping Cart/Edit Color'), [('color') : 'unselected'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Shopping Cart/Edit Quantity'), [('qty') : 'products'], FailureHandling.STOP_ON_FAILURE)
